...
- **Validation:** up to 4 video files, max 50 MiB each; allowed MIME types: `video/mp4`, `video/quicktime`, `video/x-matroska`, `video/webm`. Start offsets must be finite and ≥ 0.
