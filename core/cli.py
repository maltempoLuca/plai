...
to core.video_editor.export_side_by_side_comparison().
"""

from __future__ import annotations
from core.video_editor import SideBySideComparisonRequest, StartMode, export_side_by_side_comparison
...
def main() -> int:
    return export_side_by_side_comparison(build_request())
